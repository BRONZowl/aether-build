...
SLASH_MAP = [
    ...
    ("hooks-trust", ["/hooks"], "N/A — folder trust not ported (hooks run; trust gate Drop)"),
    ("hooks-untrust", ["/hooks"], "N/A — folder trust not ported"),
    ("plugins", [], "N/A — marketplace Drop (R3a)"),

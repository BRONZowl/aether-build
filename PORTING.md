...
|---------|--------|----------|
| Welcome / brand art | **Full (V1)** — Grok logo07/05 + stacked/hero welcome layout (Aether chrome) | Grok Braille logo + hero/stacked; shimmer N/A |
...
| Grok Braille welcome logo + shimmer | **V1** Grok logo07/05 + stacked/hero welcome (no shimmer) |

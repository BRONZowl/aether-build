...
|---------|--------|----------|
| Welcome / brand art | **Full (V1)** — Aether A×X monogram (Avengers A + SpaceX X) + stacked/hero | Grok Braille logo + hero/stacked; shimmer N/A |
...
| Grok Braille welcome logo + shimmer | **V1** Aether A×X monogram + stacked/hero layout (no shimmer) |

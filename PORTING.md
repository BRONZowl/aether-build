...
|---------|--------|----------|
| Welcome / brand art | **Full (V1)** — unique Aether geometric-A monogram + stacked/hero layout | Grok Braille logo + hero/stacked; shimmer N/A |
...
| Grok Braille welcome logo + shimmer | **V1** unique Aether geometric-A + stacked/hero layout (no shimmer) |

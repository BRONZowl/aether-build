...
|---------|--------|----------|
| Welcome / brand art | **Full (V1)** — Aether open-“A” Braille on logo07/05 canvas + stacked/hero layout | Grok Braille logo + hero/stacked; shimmer N/A |
...
| Grok Braille welcome logo + shimmer | **V1** Aether Braille monogram + stacked/hero layout (no shimmer) |

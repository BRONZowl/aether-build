...
print_help :: proc() {
	...
	fmt.println("  AETHER_NO_STREAM             Non-stream HTTP (buffer full response)")
	fmt.println("  AETHER_STREAM_STDOUT=1       Live-stream answer tokens (default: print final answer once)")
	...
	fmt.println()
	fmt.println("In TUI/REPL: /help /login /whoami /session /sessions /save /load /new /clear /quit")
	fmt.println()
	fmt.println("Other:")
